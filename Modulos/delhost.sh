...
then
	...
	read -p "Digite o domÃ­nio que deseja remover da lista: " host
	if [[ -z $host ]]
		then
		...
		then
			tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "O domÃ­nio $host nÃ£o foi encontrado no arquivo $payload" ; echo "" ; tput sgr0
			exit 1
		else
			grep -v "^$host" $payload > /tmp/a && mv /tmp/a $payload
			tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Arquivo $payload atualizado, o domÃ­nio foi removido com sucesso:" ; tput sgr0
			tput setaf 3 ; tput bold ; echo "" ; cat $payload ; echo "" ; tput sgr0
