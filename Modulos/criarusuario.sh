...
echo ""
echo -ne "\033[1;32mNome do usuÃ¡rio:\033[1;37m ";read username
[[ -z $username ]] && {
	echo -e "\n${cor1}Nome de usuÃ¡rio vazio ou invalido!${scor}\n"
	exit 1
}
...
[[ -e /etc/openvpn/server.conf ]] && {
	...
	[[ "$resp" = @(s|S) ]] && {
		...
		echo -ne "\033[1;32mGerar Com usuÃ¡rio e Senha \033[1;31m? \033[1;33m[s/n]:\033[1;37m "
		read respost
