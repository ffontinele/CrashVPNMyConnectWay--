...
if [[ -z $option ]]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "  Usuario vazio ou invÃ¡lido!   " ; echo "" ; tput sgr0
	exit 1
elif [[ -z $user ]]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo " UsuÃ¡rio vazio ou invÃ¡lido! " ; echo "" ; tput sgr0
	exit 1
else
