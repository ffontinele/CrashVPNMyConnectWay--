...
if [ ! -f "$database" ]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Arquivo $database nao encontrado" ; echo "" ; tput sgr0
	exit 1
else
    ...
    if [[ -z $option ]]; then
        tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Usuario vazio ou nao existente" ; echo "" ; tput sgr0
		exit
	elif [[ -z $usuario ]]; then
		tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Usuario vazio ou nao existente" ; echo "" ; tput sgr0
		exit 1
		...
		if cat /etc/passwd |grep -w $usuario > /dev/null; then
			...
			if [[ -z $sshnum ]]
			then
				tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "VocÃª digitou um numero invalido!" ; echo "" ; tput sgr0
				exit 1
			else
				...
				then
					...
					then
						...
						tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Limite aplicado para o usuario $usuario foi $sshnum " ; tput sgr0
						sleep 2
						exit
					fi
				fi
			...
			tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "O usuÃ¡rio $usuario nao foi encontrado" ; echo "" ; tput sgr0
			exit 1
		fi
	fi
fi
