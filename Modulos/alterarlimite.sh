#!/bin/bash
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%20s%s\n' "   Alterar limite de conexÃµes simultÃ¢neas   " ; tput sgr0
database="/root/usuarios.db"
if [ ! -f "$database" ]; then
	tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "Arquivo $database nÃ£o encontrado" ; echo "" ; tput sgr0
	exit 1
else
    ...
    if [[ -z $option ]]; then
        tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "UsuÃ¡rio vazio ou nÃ£o existente" ; echo "" ; tput sgr0
		exit
	elif [[ -z $usuario ]]; then
		tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "UsuÃ¡rio vazio ou nÃ£o existente" ; echo "" ; tput sgr0
		exit 1
		...
		if cat /etc/passwd |grep -w $usuario > /dev/null; then
			...
			if [[ -z $sshnum ]]
			then
				tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "VocÃª digitou um nÃºmero invÃ¡lido!" ; echo "" ; tput sgr0
				exit 1
			else
				...
				then
					...
					if [[ $sshnum -lt 1 ]]
					then
						tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "VocÃª deve digitar um nÃºmero maior que zero!" ; echo "" ; tput sgr0
						exit 1
					else
						...
						tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Limite aplicado para o usuÃ¡rio $usuario foi $sshnum " ; tput sgr0
						sleep 2
						exit
					fi
				fi
			...
			tput setaf 7 ; tput setab 1 ; tput bold ; echo "" ; echo "O usuÃ¡rio $usuario nÃ£o foi encontrado" ; echo "" ; tput sgr0
			exit 1
		fi
	fi
fi